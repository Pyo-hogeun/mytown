 ...
 *     responses:
 *       200:
 *         description: 관리자용 정산 목록 반환
 *       403:
 *         description: 관리자 전용 접근 제한
 */
...
router.post("/manual", authMiddleware, async (req, res) => {
  try {
    ...
    for (const [riderId, orders] of riderMap.entries()) {
      ...
      const commission = totalLength * 3000; // 건당 3,000원
